  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        {loading ? (
          <div className="glass-effect p-8 rounded-lg shadow-md border border-white/20 text-center">
            <p className="text-white">Laden...</p>
          </div>
        ) : logs.length === 0 ? (
          <div className="glass-effect p-8 rounded-lg shadow-md border border-white/20 text-center">
            <p className="text-white/85">Geen audit logs gevonden.</p>
          </div>
        ) : (
          <div className="glass-effect p-4 rounded-lg shadow-md border border-white/20 overflow-x-auto">
