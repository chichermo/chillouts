...
export default function LesuurColumnHeader({ hour, teacher }: LesuurColumnHeaderProps) {
  return (
    ...
    >
      ...
      {teacher ? (
        <span
          className="mt-1 inline-flex max-w-[68px] items-center justify-center truncate rounded-md border border-amber-400/35 bg-amber-500/20 px-1 py-0.5 text-[9px] font-medium leading-tight text-amber-100"
