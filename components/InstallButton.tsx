...
export default function InstallButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-2 bg-gradient-to-r from-brand-green to-emerald-600 text-white rounded-md hover:from-brand-green/90 hover:to-emerald-600/90 text-xs font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
    ...
    >
      ...
      <span className="xl:hidden">Inst</span>
    </button>
  );
}
